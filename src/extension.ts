...
import { registerSelectOpenEditorsCommand } from "./commands/selectOpenEditors";
...
export async function activate(context: vscode.ExtensionContext): Promise<void> {
	...
	registerSelectOpenEditorsCommand(context, fileTreeProvider, debouncedRefreshAndUpdate);
